...
export function html(data) {
  ...
  .c .today{background:${RED};color:#fff;width:38px;height:38px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:600;flex-shrink:0;line-height:1}
