...
import { pageShell, SERIF_CSS, monthWeeks, esc } from "./_common.js";
...
export function html(data) {
  ...
  const photoSvg = `<svg viewBox="0 0 520 300" width="520" height="300" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><rect width="520" height="300" fill="#fff"/><circle cx="410" cy="70" r="34" fill="#cfcfcf"/><polygon points="0,300 175,150 300,300" fill="#9a9a9a"/><polygon points="200,300 350,120 520,300" fill="#6f6f6f"/></svg>`;
  ...
  .photo svg{width:100%;height:300px;display:block;filter:grayscale(1) contrast(1.05);border:1px solid ${INK}}
